using System;
using araujo.Infrastructure.Configuration;
using Microsoft.Extensions.Options;
using System.IdentityModel.Tokens.Jwt;
using System.Text;
using araujo.Domain.Entities;
using araujo.Infrastructure.Data;
using araujo.Infrastructure.Data.Repositories;
using araujo.Security;
using araujo.Security.Jwt;
using araujo.Domain.Services;
...
using AuthenticationService = araujo.Domain.Services.AuthenticationService;
using IAuthenticationService = araujo.Domain.Services.Interfaces.IAuthenticationService;

namespace araujo.Configuration;
